...
class _ExportProtocolSession:
    ...
    def _prepare_directories(self):
        ...
        reader_name = self._communicator.reader_name

        reader_data_dir = data_dir / reader_name
    ...
    def _get_export_dates(self) -> None:

        if self._config_manager is None:
            raise RuntimeError("Configuration manager not initialized yet.")

        if self._communicator is None:
            raise RuntimeError("Communicator not initialized yet.")
    ...
    def run_export_protocol(self):
        ...
        self._communicator.standby_mode()
