...
from oregon_processing.util import (ConfigNotFoundError, InvalidConfigError, ConnectionFailedError, UnexpectedResponseError,
                                    CommandTransmissionError, UserAbortError, DeviceHealthError)
...
def run_export_protocol():
    ...
    except (ConnectionFailedError, UnexpectedResponseError, CommandTransmissionError, UserAbortError, DeviceHealthError) as e:
